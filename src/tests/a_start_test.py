...
class TestAStar(unittest.TestCase):
    ...
    def test_plane(self):
        result = a_star((10, 0), (10, 19), self.plane)
        path = result['path']
    ...
    def test_slope(self):
        result = a_star((10, 0), (10, 19), self.slope)
        path = result['path']
        correct_path = [(10, 19), (10, 18), (10, 17), (10, 16), (10, 15), (10, 14), (10, 13), (10, 12), (10, 11),
                        (10, 10), (10, 9), (10, 8), (10, 7), (10, 6), (10, 5), (10, 4), (10, 3), (10, 2), (10, 1), (10, 0)]
        self.assertEqual(correct_path, path)
    ...
    def test_zig_zag(self):
        result = a_star((10, 0), (10, 19), self.zig_zag_plane)
        path = result['path']
        correct_path = [(10, 19), (10, 18), (10, 17), (10, 16), (10, 15), (10, 14), (10, 13), (10, 12), (10, 11),
                        (10, 10), (10, 9), (10, 8), (10, 7), (10, 6), (10, 5), (10, 4), (10, 3), (10, 2), (10, 1), (10, 0)]
        self.assertEqual(correct_path, path)
    ...
    def test_corridor(self):
        result = a_star((1, 1), (18, 18), self.corridor)
        path = result['path']
        print(path)
